...
public class JavassistProxyTest {
	...
	public void test() throws CannotCompileException, NotFoundException, InstantiationException, IllegalAccessException, ClassNotFoundException, SecurityException, NoSuchMethodException, IllegalArgumentException, InvocationTargetException{
		//ClassPool是CtClass 的创建工厂。它在class path中查找CtClass的位置，并为每一个分析请求创建一个CtClass实例。
		ClassPool pool = ClassPool.getDefault();
		CtClass subject = pool.get("proxy_dynamic.javassist.RealSubject");
